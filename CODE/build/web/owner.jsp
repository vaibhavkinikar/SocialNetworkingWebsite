...
<form name="form" ENCTYPE="multipart/form-data" action="profileinsert.jsp" method="post" onSubmit="return validation();">
<!-- start header -->
<%
try{
   int id=0;
   ...
   String s = "select fname,sname,id from reg where id='"+id+"'";
...
<div id="content">
	  ...
	  &nbsp; 
       <font color="#FF0000"><font size="5"> <%=fname%></font></font>
        &nbsp; 
        <font color="#FF0000"><font size="5"><%=sname%></font></font>
		...
		<div id="tabs">
          ...
          <li><a href="#fragment-1"><font color="#CC0000">Step1:</font>Find Your 
            Friends</a></li>
          ...
          <p><font size="3"><strong>&nbsp;&nbsp;&nbsp;<font color="#000000">Are 
            Your Friends already On Facebook?</font></strong></font></p>
		  <p>&nbsp;&nbsp;&nbsp;<img src="images/mess.png" width="80" height="60"><font color="#000000">Gmail</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000">FIND 
            FRIENDS</font></p>
          <p>&nbsp;&nbsp;&nbsp;<img src="images/yahoo.png" width="60" height="60"><font color="#000000">Yahoo</font> 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000">FIND 
            FRIENDS</font></p> 
        	</div>
