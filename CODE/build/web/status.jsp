...
%>//
    <body>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="owner1.jsp?id=<%=(String) session.getAttribute("id") %>"><font color="#FFFFFF" size="3">Profile Modify</font></a></li>
                        </ul>
                    </li>
        ...
        <div id="content"> <div id="content">
            ...
            <div style="position:absolute; left:500px; top:255px;"><font color="#FFFFFF" size="5"><font color="red"> 
                &nbsp;&nbsp;&nbsp;Status Update</font></font>
...
%>
            ...
            <div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
                ...
                <div style="position:absolute; left:400px; top:341px; width: 358px; height: 140px;">
                    <form name="f1" action="block.jsp" method="get" onsubmit="return validation();">

                        <fieldset>

                            <legend><font color="#FFFFFF"><strong><font size="4">What's on your mind..!!</font></strong></font></legend>
                ...
                <%
                    ...
                    ResultSet rss = sss.executeQuery("select * from update_ where permission='"+(String)session.getAttribute("fname1")+"' or permission='public' ");
                    while (rss.next()) {
                ...
                <div style="margin-top:90px; margin-bottom: -65px; ">
                    <p><font color="yellow">Posted By</font> &nbsp;<%=names%></p>
